         ...
         <Link to='/' className="btn btn-light my-3 "> Go Back </Link> 
           ...
           <Row> 
                ...
                <Col md ={3} >
                    ...
                    <ListGroup.Item>   <Rating value = { product.rating } text = { `${product.numReviews } reviews` } color={'#f43664'} />   </ListGroup.Item>
                    ...
                    {product.countInStock > 0  && (
                        ...
                        <ListGroupItem>
                           <Row> 
                            ...
                            [...Array(product.countInStock).keys()].map((f) => (
                    ...
                    <ListGroup variant="flush">
                       { product.reviews.map((review) => ( 
                           <ListGroup.Item key={review._id}> 
                                 ...
                                 <Rating value={review.rating} color='#232333'/> 
